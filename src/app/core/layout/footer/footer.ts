...
@Component({
  ...
  <div class="mx-auto max-w-screen-xl text-center">
      ...
      <p class="my-6 text-gray-500 dark:text-gray-400">"La sabiduría de nuestros mayores vive en cada palabra"</p>

      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="#" class="hover:underline">EduShuar</a>. All Rights Reserved.</span>
  </div>
</footer>
